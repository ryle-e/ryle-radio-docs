...
### Observer Events
There're only three consistent variables in observer events.
#### Type
...
We can make sense of this event, then- whenever the volume of the track crosses a certain threshold
