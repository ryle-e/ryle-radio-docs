...
First, select a key on the dropdown. It can be anything, but given how awful Unity's selection option is for KeyCodes (I'm sure it's at least part of the reason they're pushing away KeyCodes to begin with)
