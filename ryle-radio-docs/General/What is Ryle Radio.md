...
It also contains **Observers**, which are built-in scripts allowing you to tie functionality into the radio's playing, such as invoking events when a particular track is audible to a particular output, or playing 