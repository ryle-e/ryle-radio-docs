...
First, install the sample through Unity's Package Manager. Navigate to `RyleRadio/Samples/BasicRadio`, and open `MainScene`. It should look like this: ![Basic Radio Sample scene view](Pasted%20image%2020251007223213.png)
