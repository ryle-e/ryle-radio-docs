...
First, install the sample through Unity's Package Manager. Navigate to `RyleRadio/Samples/SpatialComponents`, and open `MainScene`. It should look like this: ![Spatial Components Sample scene view](../Images/Guides/Spatial%20Components%20Sample/20251018214332.png)
...
You can see the two radii in the scene view when the broadcaster is selected! You can also drag them in the scene view like you would a normal collider. ![Broadcast Radius gizmos](../Images/Guides/Spatial%20Components%20Sample/20251018162723.png)
#### Broadcast Powers
...
#### Distance Falloff
The distance falloff is a curve showing exactly how the track will get quieter when moving between the broadcast radii. It's the shape of the volume between the inner and outer radius. For example, if it's a smooth graph like this, it'll get quieter smoothly when moving between the radii. ![Smooth distance falloff](../Images/Guides/Spatial%20Components%20Sample/20251008143627.png)
For a linear graph like this, it'll get quieter linearly between the radii. ![Linear distance falloff](../Images/Guides/Spatial%20Components%20Sample/20251008143659.png)
Something like this, though, would mean that an output between the radii would keep the track loud right up until it gets close to the outer radius- at which point it would start getting quieter. ![Tapered distance falloff](../Images/Guides/Spatial%20Components%20Sample/20251008143753.png)
